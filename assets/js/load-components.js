    ...
    const pageHeaders = {
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="w-100" 
                             ...
                             srcset="assets/images/carousel-1.png 1920w, assets/images/carousel-1.png 1280w, assets/images/carousel-1.png 768w" 
                             sizes="100vw" 
                    ...
                    <div class="carousel-item">
                        <img class="w-100" 
                             ...
                             srcset="assets/images/carousel-2.png 1920w, assets/images/carousel-2.png 1280w, assets/images/carousel-2.png 768w" 
                             sizes="100vw" 
                             alt="Creative Agency Slide 2" 
                             width="1920" 
                             height="1080" 
                             loading="lazy">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
        ...
        'booking': `
            <div class="container-fluid bg-primary py-5 bg-header mrb-90">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-4 text-white animated zoomIn">Book a Call</h1>
                        <a href="index.html" class="h5 text-white">Home</a>
                        <i class="far fa-circle text-white px-2"></i>
                        <a href="booking.html" class="h5 text-white">Book a Call</a>
                    </div>
                </div>
            </div>
        `,
